...
class HealthChecker:
    ...
    def check_all(self, *, verbose: bool = False) -> SystemHealth:
        ...
        # Check psql CLI (optional)
        components.append(self.check_psql())

        # Check connectivity
        components.append(self.check_connectivity())
    ...
    def check_psql(self) -> ComponentHealth:
    ...
    def display_health(
        ...
        *,
        ...
        icon = self._get_status_icon(health.overall_status)
        ...
        # Component table
        table = self._create_component_table(health.components)
